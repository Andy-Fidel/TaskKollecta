    ...
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-card rounded-xl shadow-sm border border-border p-8 sm:p-12">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">6. Service Providers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">7. Your Data Rights</h2>
            <p>
